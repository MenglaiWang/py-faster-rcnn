...
class hs(imdb):
    ...
    def _get_default_path(self):    # modified
        """
        Return the default path where PASCAL VOC is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'hs')
...
if __name__ == '__main__':
    ...
    d = hs('hs','/home/dl215/workspace/wangml/personruns-faster-rcnn/lib/datasets')
    res = d.roidb
